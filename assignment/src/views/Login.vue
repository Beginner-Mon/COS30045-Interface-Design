<template>
  <div class="min-vh-100 d-flex align-items-center justify-content-center position-relative overflow-hidden p-3">
    ...
    <div class="auth-card p-4 p-sm-5" style="max-width: 400px">
      <div class="text-center mb-4">
        <h1 class="mb-2 fs-3 fw-bold text-white">Welcome Back</h1>
      ...
      <form @submit.prevent="handleEmailLogin">
        ...
        <button type="submit" class="btn auth-btn w-100 mb-3" :disabled="isLoading">
      ...
      <!-- Google Sign In -->
      <button @click="handleGoogleLogin" class="btn auth-btn w-100 mb-3" :disabled="isLoading">
